...
const file_proto_api_proto_rawDesc = "" +
	"\n" +
	"\x0fproto/api.proto\x12\x03api\"\x10\n" +
	"\x0eRollDieRequest\"'\n" +
	"\x0fRollDieResponse\x12\x14\n" +
	"\x05value\x18\x01 \x01(\x05R\x05value2E\n" +
	"\vDiceService\x126\n" +
	"\aRollDie\x12\x13.api.RollDieRequest\x1a\x14.api.RollDieResponse\"\x00B/Z-github.com/lolasudo/golink-p2p/practice-4/apib\x06proto3"
